 ...
 *         title="我想找个人",
 *         description="",
 *         termsOfService="http://zhaogeren.localhost.com/",
 *         @SWG\Contact(name="Xiaomage"),
 *         @SWG\License(name="MIT")
 *     ),
 *    @SWG\SecurityScheme(
 *      securityDefinition="orangins_auth",
 *      type="oauth2",
 *      authorizationUrl="http://zhaogeren.localhost.com/user/access-token",
 *      flow="implicit",
 *      scopes={
 *      "access_token": "需要用户登录才有权限操作",
 *    }
 * )
 * )
 */
